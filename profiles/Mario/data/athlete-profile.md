...
| Fokus-Distanzen | primär Ironman, sekundär Ironman 70.3 und olympische Distanz |

## Verfügbarkeit und Trainingsumfeld

Die Standard-Verfügbarkeit steht in `data/availability.md`.
...
Aktueller Zustand, Beschwerden und kurzfristige Warnsignale gehören in `data/current-state.md`.
...
## Typische Mahlzeiten
### Morgens
- 2 Bröchten mit Butter und süßem Aufstrich (Nutella, Honig, Marmelade)
### Mittags
- oft nur wenig
- Rest vom Vortag
- Müsli
### Abends
- Entweder Brotzeit mit Broten, Butter, Käse, vegetarischer Ersatzwurst
- Einfachere warme Mahlzeiten wie Wraps, Reis-Curry, etc.
...
| Standard Bike-Pausenleistung bei Intervallen | 100W |
| Normaler Long Bike Umfang | 2:30h-4:00h |
